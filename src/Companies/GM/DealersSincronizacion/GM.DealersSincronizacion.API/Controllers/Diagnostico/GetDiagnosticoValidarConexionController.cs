...
public class GetDiagnosticoValidarConexionController : ControllerBase
{
    ...
    /// ejecutando una consulta de validación (SELECT 1 FROM DUAL). Útil para monitoreo
    ...
    /// - Si la consulta falla, retorna isValid=false y error 400 Bad Request
    /// 
    /// **Respuesta exitosa incluye:**
    /// - Estado de validación de la conexión
    /// - Tiempo de respuesta de la consulta
    /// - Timestamp de la operación
    /// </remarks>
    /// <returns>Estado de validación de la conexión Oracle</returns>
    /// <response code="200">Operación exitosa. Retorna estado de validación de la conexión.</response>
    /// <response code="400">Conexión no válida. La consulta de validación falló.</response>
