...
/// <summary>
/// DTO para lectura de Evento de Carga de Proceso.
/// </summary>
...
/// <summary>
/// DTO para creación de Evento de Carga de Proceso.
/// </summary>
public class CrearEventoCargaProcesoDto
{
    /// <summary>
    ...
    /// </summary>
    [StringLength(100, ErrorMessage = "El nombre de la tabla relacionada no puede exceder 100 caracteres")]
    public string? TablaRelacion { get; set; }

    /// <summary>
    /// Componente relacionado (opcional).
    /// </summary>
    [StringLength(100, ErrorMessage = "El componente relacionado no puede exceder 100 caracteres")]
    public string? ComponenteRelacionado { get; set; }
}

/// <summary>
/// DTO para filtros de búsqueda de Evento de Carga de Proceso.
/// </summary>
public class FiltrosEventoCargaProcesoDto
{
    /// <summary>
