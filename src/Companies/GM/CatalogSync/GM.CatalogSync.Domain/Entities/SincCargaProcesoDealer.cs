...
public class SincCargaProcesoDealer
{
    ...
    /// NOTA: Este campo NO se guarda en la tabla CO_SINCRONIZACIONCARGAPROCESODEALER (no existe COSC_PROCESO).
    /// Se obtiene mediante JOIN con CO_EVENTOSCARGAPROCESO.COCP_PROCESO.
    /// </summary>
